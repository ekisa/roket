...
public class EmirResourceIntTest {
    ...
    private static final EMIR_STATU UPDATED_STATU = EMIR_STATU.ATANDI;

    private static final BOYUT DEFAULT_BOYUT = BOYUT.BIR;
    private static final BOYUT UPDATED_BOYUT = BOYUT.IKI;
    ...
    public void createEmir() throws Exception {
        ...
        assertThat(testEmir.getBoyut()).isEqualTo(DEFAULT_BOYUT);
    }
    ...
    @Test
    @Transactional
    public void checkBoyutIsRequired() throws Exception {
        int databaseSizeBeforeTest = emirRepository.findAll().size();
        // set the field null
        emir.setBoyut(null);
    ...
    public void getAllEmirs() throws Exception {
        ...
        restEmirMockMvc.perform(get("/api/emirs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].boyut").value(hasItem(DEFAULT_BOYUT.toString())));
    }
    ...
    public void getEmir() throws Exception {
        ...
        restEmirMockMvc.perform(get("/api/emirs/{id}", emir.getId()))
            ...
            .andExpect(jsonPath("$.boyut").value(DEFAULT_BOYUT.toString()));
    }
    ...
    public void updateEmir() throws Exception {
        ...
        assertThat(testEmir.getBoyut()).isEqualTo(UPDATED_BOYUT);
    }
