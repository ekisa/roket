...
describe('Emir e2e test', () => {
    ...
    it('should create and save Emirs', () => {
        ...
        emirDialogPage.boyutSelectLastOption();
...
export class EmirDialogPage {
    ...
    boyutSelect = element(by.css('select#field_boyut'));
    ...
    setBoyutSelect = function(boyut) {
        this.boyutSelect.sendKeys(boyut);
    }

    getBoyutSelect = function() {
        return this.boyutSelect.element(by.css('option:checked')).getText();
    }

    boyutSelectLastOption = function() {
        this.boyutSelect.all(by.tagName('option')).last().click();
    }
